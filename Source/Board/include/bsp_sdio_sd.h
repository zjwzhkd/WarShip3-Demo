...
/*SD卡CSD寄存器数据(Card Specific Data)*/
typedef struct
{
...
/*SD卡CID寄存器数据(Card Identification Data)*/
typedef struct
{
...
typedef struct
{
    SD_CSD   SD_csd;                    /*!< SD card specific data register */
    SD_CID   SD_cid;                    /*!< SD card identification number register */
